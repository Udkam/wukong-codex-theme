...
export const DEFAULT_THEME = {
  ...
  background: {
    ...
    gallery: [
      ...
      { id: 'shadow-confrontation', slot: 'B04', order: 4, asset: 'backgrounds/battle-04.jpg', position: 'center center', mode: 'battle-secondary', tone: 'midnight-blue', veil: 0.99, threadVeil: 0.18, heroProfile: 'bone-on-dark-flat' },
      { id: 'ridge-gate', slot: 'S01', order: 3, asset: 'backgrounds/scenery-01.jpg', position: 'center center', mode: 'scenery', tone: 'ridge-umber', veil: 0.67, threadVeil: 0.28, heroProfile: 'bone-on-dark-complex' },
      { id: 'sunset-ravine', slot: 'S05', order: 2, asset: 'backgrounds/scenery-05.jpg', position: 'center center', mode: 'scenery', tone: 'sunset-copper', veil: 0.68, threadVeil: 0.42, heroProfile: 'ink-on-light-flat' },
      { id: 'training-sunset', slot: 'B05', order: 5, asset: 'backgrounds/battle-05.jpg', position: 'center center', mode: 'battle-secondary', tone: 'sage-sepia', veil: 0.85, threadVeil: 0.56, heroProfile: 'ink-on-light-complex' },
      { id: 'thunder-dragon-ascent', slot: 'B06', order: 8, asset: 'backgrounds/battle-06.jpg', position: 'center center', mode: 'battle-secondary', tone: 'storm-cyan', veil: 0.73, threadVeil: 0.58, heroProfile: 'ink-on-light-complex' },
      ...
      { id: 'white-tiger', slot: 'B08', order: 6, asset: 'backgrounds/battle-08.jpg', position: 'center center', mode: 'battle-secondary', tone: 'storm-cyan', veil: 0.73, threadVeil: 0.30, heroProfile: 'ink-on-light-flat' },
      { id: 'red-lightning', slot: 'B09', order: 7, asset: 'backgrounds/battle-09.jpg', position: 'center center', mode: 'battle-secondary', tone: 'yaksha-lacquer', veil: 0.68, threadVeil: 0.18, heroProfile: 'ink-on-light-complex' },
      { id: 'snow-lake', slot: 'S08', order: 1, asset: 'backgrounds/scenery-08.jpg', position: 'center center', mode: 'scenery', tone: 'storm-cyan', veil: 0.48, threadVeil: 0.48, heroProfile: 'ink-on-light-flat' },
      { id: 'white-dragon-frost', slot: 'B11', order: 9, asset: 'backgrounds/battle-11.jpg', position: 'center center', mode: 'battle-secondary', tone: 'storm-cyan', veil: 0.73, threadVeil: 0.58, heroProfile: 'ink-on-light-complex' },
      { id: 'night-spear-confrontation', slot: 'B16', order: 10, asset: 'backgrounds/battle-16.jpg', position: 'center center', mode: 'battle-secondary', tone: 'staff-gold', veil: 0.82, threadVeil: 0.34, heroProfile: 'bone-on-dark-complex' }
    ]
  },
  accessibility: {
    preset: 'workbench',
